...
{
    bool create(std::shared_ptr<QSqlDatabase> db);
    bool insertTileSet(std::shared_ptr<QSqlDatabase> db, const QGCCachedTileSet &tileSet);
...
namespace TilesTableModel
{
    ...
    bool selectFromSetID(std::shared_ptr<QSqlDatabase> db, quint64 tileID);
    ...
    bool updateSetTotals(std::shared_ptr<QSqlDatabase> db, QGCCachedTileSet &set, quint64 setID);
...
{
    bool create(std::shared_ptr<QSqlDatabase> db);
    bool insertTilesDownload(std::shared_ptr<QSqlDatabase> db, QGCCachedTileSet* tileSet);
