...
bool TileSetsTableModel::insertTileSet(std::shared_ptr<QSqlDatabase> db, const QGCCachedTileSet &tileSet)
{
    QSqlQuery query(*db);
    (void) query.prepare(
...
bool TilesTableModel::selectFromSetID(std::shared_ptr<QSqlDatabase> db, quint64 tileID)
{
    QSqlQuery query(*db);
...
bool TilesTableModel::updateSetTotals(std::shared_ptr<QSqlDatabase> db, QGCCachedTileSet &set, quint64 setID)
{
    QSqlQuery query(*db);
...
bool TilesDownloadTableModel::insertTilesDownload(std::shared_ptr<QSqlDatabase> db, QGCCachedTileSet* tileSet)
{
    QSqlQuery query(*db);
